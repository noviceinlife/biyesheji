					...
					<c:if test="${goodss!=null &&  fn:length(goodss)>0}">
					   ...
					   <tr> 
					     <td width="" align="center" title='${goods.goods_name}'>
					     	<a href="page_queryMyGoods.action?goods_id=${goods.goods_id}">
					     ...
					     <td width="" align="center">${goods.goods_saleDesc}</td>
					     <td width="" align="center">${fn:substring(goods.goods_date,0,10)}</td>
					     <td width="" align="center">
					       <a href="page_editGoods.action?goods_id=${goods.goods_id}">编辑</a>&nbsp;
