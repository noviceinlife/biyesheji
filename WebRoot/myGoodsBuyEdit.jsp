...
<html>
<head>
<title>${goods!=null && goods.goods_id!=0?'编辑':'添加'}商品求购</title>
...
<div id="middle">
	 ...
	 <!--  购物车 -->
	 <div id="product_info">
			<div class="title">个人中心  &gt;&gt;  ${goods!=null && goods.goods_id!=0?'编辑':'添加'}商品求购</div>
			<div style="margin-top:5px">
				 ...
				 <input type="hidden" name="goods_flag" id="goods_flag" value="2"/>
