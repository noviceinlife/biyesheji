				...
				<TR>
					...
					<TBODY>
						<TR>
							...
							<TD style="HEIGHT: 28px" width=150><INPUT id="params.user_name" name="user_name" value="${params.user_name}" style="WIDTH: 130px" name=txtName></TD>
						...
						<TR>
							...
							<TD style="HEIGHT: 28px"><INPUT id="params.user_pass" name="user_pass"   style="WIDTH: 130px" 
							  type="password"></TD>
